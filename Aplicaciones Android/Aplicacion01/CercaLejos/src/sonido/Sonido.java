...
public class Sonido 
{
	...
	private Activity contexto;		// Contexto
	...
	//private Equalizer ecualizador;	// Con la clase Equalizer se maneja la frecuencia del sonido
	//private short bandasfrecuencia;	// Bandas de frecuencia
	//private short bandaminima, bandamaxima;
	 ...
	 */
	@SuppressLint("NewApi")
	public Sonido(Activity contexto, String nombre)
	{
		...
		/*ecualizador = new Equalizer(0, sonido.getAudioSessionId());		
		
		Log.i("Sonido", "Control de los efectos1: " + ecualizador.setEnabled(Boolean.TRUE));
		Log.i("Sonido", "Control de los efectos2: " + ecualizador.hasControl());
		bandasfrecuencia = ecualizador.getNumberOfBands();
		bandaminima = ecualizador.getBandLevelRange()[0];
        bandamaxima = ecualizador.getBandLevelRange()[1];
        for (short i = 0; i < bandasfrecuencia; i++) 
        {
        	Log.i("EqualizerSample", i + String.valueOf(ecualizador.getCenterFreq(i) / 1000) + " Hz");
            ecualizador.setBandLevel(i, (short)((bandaminima + bandamaxima) / 2));
        }*/
	}
	
	/*public void cambiarFrecuencia(int incremento)
	{
		for (short i = 0; i < bandasfrecuencia; i++) 
        {
        	Log.i("EqualizerSample", i + String.valueOf(ecualizador.getCenterFreq(i) / 1000) + " Hz");
	...
	/*public int getBandasFrecuencia()
	{
		return ecualizador.getNumberOfBands();
	}*/
	
	/*public int getBandaFrecuenciaMinima()
	{
		return bandaminima;
	}*/
	
	/*public int getBandaFrecuenciaMaxima()
	{
		return bandamaxima;
	}*/
	 ...
	 */
	private void setContexto(Activity contexto) 
	{
