...
import com.example.debajodeunboton.*;
...
public class ToolTipView extends LinearLayout implements ViewTreeObserver.OnPreDrawListener, View.OnClickListener {
    ...
    private ImageView imagenChunga;
    //
    ...
    private void init() {
        ...
        imagenChunga = (ImageView) findViewById(R.id.imagenTooltip);
    ...
    public boolean onPreDraw() {
        ...
        if(mToolTip.getImagen()>=0){
        	imagenChunga.setImageResource(mToolTip.getImagen());
        }
        if(mToolTip.getImagenPath()!=null){
        	imagenChunga.setImageDrawable(Drawable.createFromPath(mToolTip.getImagenPath()));
        }
	...
	private void applyToolTipPosition() {
        ...
        float toolTipViewY;
        mRightPointerView.setVisibility(GONE);
...
//        setY(toolTipViewY);
        ...
        }else if (mToolTip.getAnimationType() == ToolTip.ANIMATIONTYPE_FROMLEFT){
//        	animators.add(ObjectAnimator.ofFloat(this, "translationY", mRelativeMasterViewY + mView.getHeight() / 2 - getHeight() / 2,toolTipViewX -masterViewHeight));
//            animators.add(ObjectAnimator.ofFloat(this, "translationX", mRelativeMasterViewY + mView.getHeight() / 2 - getHeight() / 2, toolTipViewY));
            animators.add(ObjectAnimator.ofFloat(this, "translationX", mRelativeMasterViewX, mRelativeMasterViewX- mWidth));
            animators.add(ObjectAnimator.ofFloat(this, "translationY", mRelativeMasterViewY - getHeight() / 2,mRelativeMasterViewY - getHeight() / 2));
            mRightPointerView.setVisibility(VISIBLE);
            mTopPointerView.setVisibility(GONE);
            mBottomPointerView.setVisibility(GONE);
        }
//      setPointerCenterY(masterViewHeight);
    ...
    public void setPointerCenterY(int pointerCenterY){
    	int pointerHeight = mRightPointerView.getMeasuredWidth();

//    	ViewHelper.setY(mRightPointerView, pointerCenterY - pointerHeight / 2 - getX());
    	ViewHelper.setY(mRightPointerView, pointerCenterY - pointerHeight / 2);
    }
    ...
    public void setColor(int color) {
        ...
        mRightPointerView.setColorFilter(color, PorterDuff.Mode.MULTIPLY);
    ...
    public void remove() {
        ...
        if (mToolTip.getAnimationType() == ToolTip.ANIMATIONTYPE_FROMMASTERVIEW) {
            ...
            animators.add(ObjectAnimator.ofFloat(this, "translationY", mRelativeMasterViewY - getHeight() / 2, mRelativeMasterViewY - getHeight() / 2));
            animators.add(ObjectAnimator.ofFloat(this, "translationX", mRelativeMasterViewX- mWidth, mRelativeMasterViewX));
        }
        else {
