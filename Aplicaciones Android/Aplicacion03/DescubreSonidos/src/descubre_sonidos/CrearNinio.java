...
public class CrearNinio extends Activity 
{
	...
	private Button bCancelarNinioCrera;
	private ImageView imagen_tooltip;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		bCancelarNinioCrera = (Button)findViewById(R.id.bCancelarNinioCrera);
		edNombreNinioCrear = (EditText)findViewById(R.id.edNombreNinioCrear);
		
		
		try
		{
			if( imagen_tooltip == null )
				Log.i("Crear Ninio", "imagen_tooltip null");
			else
				Log.i("Crear Ninio", "imagen_tooltip no null");
			Drawable imagen = getResources().getDrawable(R.drawable.microfono_grabando);
			imagen_tooltip.setImageDrawable(imagen);
			imagen_tooltip.setImageResource(R.drawable.gafas);			
		}
		catch(Exception e)
		{
			Log.i("Crear Ninio", "ERROR: " + e.toString());
		}
