...
import grafica.FormatoEtiquetasGrafico;
...
public class Evaluar extends Activity 
{
	...
	private EditText edAciertosEvaluacion, edFallosEvaluacion, edTiempoRealizacion;
	...
	public void mostrarGraficoEvolucionNinio()
	{
		...
		if( indiceprincipio <= indicefinal )
		{
			...
			ArrayList<ArrayList<Integer>> totaldatos = aux.obtenerTodosAciertosFallosTiemposEjecucion(ninioseleccionado, actividadseleccionada);		
			...
			UtilidadesGraficas.mostrarGrafico(titulo, aciertos, fallos, tiempos2, fechas2, layoutmostrargrafico);
		}
		else
		{
