/**
 * @author francis
 * Esta clase nos permitirá modificar un perfil para la aplicación de descubre sonidos
 */
...
public class Modificar_actividad extends Activity implements ToolTipView.OnToolTipViewClickedListener 
{
	...
	private String rutaayuda, actividadseleccionada;
	...
	private CheckBox cbActivoImagen01Modif, cbActivoImagen02Modif, cbActivoImagen03Modif, cbActivoImagen04Modif, cbActivoImagen05Modif, cbActivoImagen06Modif;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		final CheckBox cbActivoSonido01Modif = (CheckBox)findViewById(R.id.cbActivoSonido01Modif);
		final CheckBox cbActivoSonido02Modif = (CheckBox)findViewById(R.id.cbActivoSonido02Modif);
		final CheckBox cbActivoSonido03Modif = (CheckBox)findViewById(R.id.cbActivoSonido03Modif);
		final CheckBox cbActivoSonido04Modif = (CheckBox)findViewById(R.id.cbActivoSonido04Modif);
		final CheckBox cbActivoSonido05Modif = (CheckBox)findViewById(R.id.cbActivoSonido05Modif);
		final CheckBox cbActivoSonido06Modif = (CheckBox)findViewById(R.id.cbActivoSonido06Modif);
		...
		final CheckBox cbEstimuloNegativoModif = (CheckBox)findViewById(R.id.cbEstimuloNegativoModif);
		...
		final CheckBox cbActivoDescripcionModif = (CheckBox)findViewById(R.id.cbActivoDescripcionModif);
		...
		// Obtengo los datos de la configuración y muestro en pantalla los oportunos
		...
		cbActivoDescripcionModif.setChecked(activadescripcion);
		rutasestimulospositivos = configuracion.getRutasEstimulosPositivos();
		tCantidadEstimulosPositivosModif.setText("" + rutasestimulospositivos.size() + " refuerzos");
		
		// Sobrecargo el método del spinner para seleccionar la actividad a modificar
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						...
						{
							rutadescripcion = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_descripcion.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando01 )
						{
							rutacancion01 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion01.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando02 )
						{
							rutacancion02 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion02.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando03 )
						{
							rutacancion03 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion03.wav";
		...
		ibGrabar04Modif.setOnClickListener(new View.OnClickListener() 
		{
			@Override
			/**
			 * Acción onClick del botón ibGrabar04Modif
			 * @param evento onClick
			 */
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando04 )
						{
							rutacancion04 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion04.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando05 )
						{
							rutacancion05 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion05.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabando06 )
						{
							rutacancion06 = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion06.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( actividadseleccionada.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_actividad)) != 0 )
					{
						if( !grabandoayuda )
						{
							rutaayuda = Environment.getExternalStorageDirectory() + "/descubre_sonidos_" + actividadseleccionada + "_cancion06.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					...
					{						
						...
						{
							case 1:
								textoerror = "Está activa la descripción de la actividad pero no se ha elegido un fichero de audio";
								break;
							case 2:
	...
	private FileChooserDialog.OnFileSelectedListener onFileSelectedListener = new FileChooserDialog.OnFileSelectedListener() 
	{
		...
		public void onFileSelected(Dialog source, File file) 
		{
			...
			source.hide();
			UtilidadesVarias.mostrarToastText(actividadactual, "Seleccionado: " + file.getName());
		}
	 ...
	 * 				1.- Está activa la descripción de la actividad pero no se ha elegido un fichero de audio
	...
	public void tomarFoto()
	{
		...
		{
			String rutaimagen = Environment.getExternalStorageDirectory() + "/descubre_sonidos" + actividadseleccionada;
