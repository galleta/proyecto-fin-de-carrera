...
public class ToolTip {
    ...
    public static final int ANIMATIONTYPE_FROMLEFT = 103;
    public static final int ANIMATIONTYPE_FROMRIGHT = 104;
    //
    ...
    public ToolTip withImage(int res){
    	imagen = res;
    	return this;
    }
    
    public ToolTip withImage(String res){
    	imagenPath = res;
    	return this;
    }
