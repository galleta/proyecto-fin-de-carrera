...
public class ConfiguracionActividad 
{
	...
	private ArrayList<Integer> ordenreproduccion;
	...
	public ConfiguracionActividad(Context contexto, String nombreactividad, 
			...
			ArrayList<Integer> orden, String rutadescripcion, boolean estaactivadescripcion)
	{
		this.contexto = contexto;
		...
		this.setOrdenReproduccion(orden);
	...
	public void almacenar()
	{
		...
		for(int i = 0; i < 6; i++)
		{
			...
			editor.putInt(aux, this.getOrdenReproduccion().get(i));
		}
		 ...
		 * 
		 * en este caso: /data/data/com.example.debajodeunboton/shared_prefs/nombre_coleccion.xml
		 */
	}
	
	/**
	 * Obtiene la actividad que se quiera de un fichero del tipo ConfiguracionActividadXXX.xml
	 * Cuando la actividad se obtiene NO puede estar creada
	...
	public void obtener(String nombreactividad)
	{
		if( nombreactividad.compareTo(UtilidadesVarias.obtenerStringXML(contexto, R.string.no_actividades_creadas)) != 0 )
		{
			...
			for(int i = 0; i < 6; i++)
			{
				String aux = "ORDEN";
				aux += String.valueOf(i);
				ordenreproduccion.add(prefs.getInt(aux, 0));
			}
	...
	/**
	 * Devuelve el orden de reproducción de los trozos de la canción de la actividad
	 * @return Array con los órdenes de reproducción de los trozos de la canción
	 */
	...
	/**
	 * Modifica el orden de reproducción de los trozos de la canción de la actividad
	 * @param ordenreproduccion Array con el nuevo orden de los trozos de la canción
	 */
	public void setOrdenReproduccion(ArrayList<Integer> ordenreproduccion) 
	{
