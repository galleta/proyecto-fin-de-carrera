/**
 * @author francis
 * Esta clase nos permitirá crear un nuevo perfil para la aplicación de debajo de un botón
 */
...
public class CrearActividad extends Activity implements ToolTipView.OnToolTipViewClickedListener 
{
	...
	private EditText edOrdenElemento01, edOrdenElemento02, edOrdenElemento03, edOrdenElemento04, edOrdenElemento05, edOrdenElemento06;
	...
	private CheckBox cbActivoDescripcion;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		edOrdenElemento01 = (EditText)findViewById(R.id.edOrdenElemento01);
		edOrdenElemento02 = (EditText)findViewById(R.id.edOrdenElemento02);
		edOrdenElemento03 = (EditText)findViewById(R.id.edOrdenElemento03);
		edOrdenElemento04 = (EditText)findViewById(R.id.edOrdenElemento04);
		edOrdenElemento05 = (EditText)findViewById(R.id.edOrdenElemento05);
		edOrdenElemento06 = (EditText)findViewById(R.id.edOrdenElemento06);
		
		cbActivoDescripcion = (CheckBox)findViewById(R.id.cbActivoDescripcion);
		...
		cbActivoSonido01.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento01.setText("0");
						edOrdenElemento01.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento01.setText("1");
						edOrdenElemento01.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
		...
		cbActivoSonido02.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento02.setText("0");
						edOrdenElemento02.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento02.setText("2");
						edOrdenElemento02.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
		...
		cbActivoSonido03.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento03.setText("0");
						edOrdenElemento03.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento03.setText("3");
						edOrdenElemento03.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
		...
		cbActivoSonido04.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento04.setText("0");
						edOrdenElemento04.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento04.setText("4");
						edOrdenElemento04.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
		...
		cbActivoSonido05.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento05.setText("0");
						edOrdenElemento05.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento05.setText("5");
						edOrdenElemento05.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
		...
		cbActivoSonido06.setOnClickListener(new CheckBox.OnClickListener()
		{
			...
			public void onClick(View evento) 
			{
				try
				{
					...
					{
						edOrdenElemento06.setText("0");
						edOrdenElemento06.setEnabled(Boolean.FALSE);
					}
					else
					{
						edOrdenElemento06.setText("6");
						edOrdenElemento06.setEnabled(Boolean.TRUE);
					}
				}
				catch (Exception e) 
				{
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando01 )
						{
							rutacancion01 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion01.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando02 )
						{
							rutacancion02 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion02.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando03 )
						{
							rutacancion03 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion03.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando04 )
						{
							rutacancion04 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion04.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando05 )
						{
							rutacancion05 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion05.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabando06 )
						{
							rutacancion06 = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion06.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						if( !grabandoayuda )
						{
							rutaayuda = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_cancion06.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					if( edNombreActividad.getText().toString().compareTo("") != 0 )
					{
						...
						{
							rutadescripcion = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString() + "_descripcion.wav";
			...
			public void onClick(View evento)
			{
				try
				{
					...
					if( error == 0 )
					{
						...
						elemento = Integer.valueOf(edOrdenElemento01.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						elemento = Integer.valueOf(edOrdenElemento02.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						elemento = Integer.valueOf(edOrdenElemento03.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						elemento = Integer.valueOf(edOrdenElemento04.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						elemento = Integer.valueOf(edOrdenElemento05.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						elemento = Integer.valueOf(edOrdenElemento06.getText().toString());
						if( elemento != 0 )
							elementostotales++;
						ordenaux.add(elemento);
						...
						{
							UtilidadesVarias.mostrarToastText(CrearActividad.this, "ERROR: los órdenes de reproducción son incorrectos");
						}
					}
					else
					{						
															...
															if( estaactivaimagen06 && rutaimagen06.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_imagen_seleccionada)) == 0 )
																...
																if( estaactivoestimulonegativo && rutaestimulonegativo.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_sonido_seleccionado)) == 0 )
																	...
																	if( rutaayuda.compareTo(UtilidadesVarias.obtenerStringXML(getBaseContext(), R.string.no_sonido_seleccionado)) == 0 )
																		...
																		if( (Integer.valueOf(edOrdenElemento01.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento01.getText().toString()) < 0 ||
																				Integer.valueOf(edOrdenElemento02.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento02.getText().toString()) < 0 ||
																				Integer.valueOf(edOrdenElemento03.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento03.getText().toString()) < 0 ||
																				Integer.valueOf(edOrdenElemento04.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento04.getText().toString()) < 0 ||
																				Integer.valueOf(edOrdenElemento05.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento05.getText().toString()) < 0 ||
																				Integer.valueOf(edOrdenElemento06.getText().toString()) > 6 || Integer.valueOf(edOrdenElemento06.getText().toString()) < 0) )
																			error = 17;
																		else
	...
	public void tomarFoto()
	{
		...
		{
			String rutaimagen = Environment.getExternalStorageDirectory() + "/hacer_musica_" + edNombreActividad.getText().toString();
