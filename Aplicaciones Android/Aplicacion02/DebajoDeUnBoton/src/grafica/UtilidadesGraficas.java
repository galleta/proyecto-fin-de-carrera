...
{
	/**
	 * MUestra un gráficos valores de los desvíos de los niños
	 * @param titulo Título del gráfico
	 * @param aciertos Evolución de los aciertos
	 * @param fallos Evolución de los fallos
	 * @param vescuchado Veces que ha escuchado el niño su composición (válido para el modo Componer)
	 ...
	 */
	public static void mostrarGrafico(String titulo, ArrayList<Integer> aciertos, ArrayList<Integer> fallos, ArrayList<Integer> vescuchado, ArrayList<Double> tiempos, ArrayList<String> fechas, XYPlot layoutgrafico)
	{
		layoutgrafico.clear();
		layoutgrafico.setTitle(titulo);
		layoutgrafico.setDomainLabel("Actividades");
		layoutgrafico.setRangeLabel("Aciertos / Fallos / Escuchado / Tiempo (minutos)");
		...
		// Formateo la leyenda
		layoutgrafico.getLegendWidget().setTableModel(new DynamicTableModel(3, 2));
		layoutgrafico.getLegendWidget().setSize(new SizeMetrics(45, SizeLayoutType.ABSOLUTE, 325, SizeLayoutType.ABSOLUTE));
        ...
        XYSeries serievescuchado = new SimpleXYSeries(
        		vescuchado,  							// Array de datos
                SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, // Sólo valores verticales
                "Veces escuchado");
        ...
        LineAndPointFormatter formatoaciertos = new LineAndPointFormatter(
                ...
                null, 									// Relleno (no hay relleno)
                null /*new PointLabelFormatter(Color.WHITE)*/);  // Texto para los puntos
        LineAndPointFormatter formatovescuchado = new LineAndPointFormatter(
                Color.rgb(255, 0, 255),                 // Color de la línea
                Color.rgb(255, 0, 255),                 // Color del punto
                null, 									// Relleno (no hay relleno)
                null /*new PointLabelFormatter(Color.WHITE)*/);  // Texto para los puntos
        ...
        layoutgrafico.addSeries(serievescuchado, formatovescuchado);
